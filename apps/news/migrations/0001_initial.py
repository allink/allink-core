# -*- coding: utf-8 -*-
# Generated by Django 1.9.13 on 2017-07-06 17:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auto_generated_category', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='auto_generated_from_news', to='allink_categories.AllinkCategory')),
                ('categories', models.ManyToManyField(blank=True, to='allink_categories.AllinkCategory')),
                ('content_additional_placeholder', cms.models.fields.PlaceholderField(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='news_news_content_additional_placeholder', slotname='news_content_additional', to='cms.Placeholder')),
                ...
                ('preview_image', filer.fields.image.FilerImageField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='news_news_preview_image', to='filer.Image', verbose_name='Preview Image')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manual_entries', aldryn_common.admin_fields.sortedm2m.SortedM2MModelField(blank=True, help_text='Select and arrange specific entries, or, leave blank to select all. (If manual entries are selected the category filtering will be ignored.)', to='news.News')),
            ],
            options={
                'abstract': False,
            },
