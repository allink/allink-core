    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bg_enabled', models.BooleanField(default=True, help_text='Show default image placeholder background color.<br><strong>Important:</strong> Disabling this option results in a transparent background even if a specific color is set (this makes sense when a transparent PNG image is used)', verbose_name='Placeholder Background Color')),
                ('icon_enabled', models.BooleanField(default=True, help_text='Show the icon that is used as long as the image is loading.<br><strong>Important:</strong> Disable this option if a transparent PNG image is used.', verbose_name='Loader Icon')),
                ...
                ('link_apphook_page', cms.models.fields.PageField(help_text='If provided, overrides the external link.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='allink_image_allinkimageplugin_app_legacy_redirects', to='cms.Page', verbose_name='New Apphook-Page')),
                ...
                ('picture', filer.fields.image.FilerImageField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='allink_image_allinkimageplugin_picture', to='filer.Image', verbose_name='Image')),
            ],
            options={
                'abstract': False,
            },
