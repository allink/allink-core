...
- we removed the app testimonials from core/apps. you need to delete all occurrences of `allink_apps.testimonials`, `apps.testimonials`, and file `__testimonials.scss` [#51](https://github.com/allink/allink-core/pull/51)
