...
#### IMPORTANT
###### TEMPLATES
- if you have overridden base_root.html you need to load google_tag_manager from allink_google_tag_manager_tags instead of google_tag_manager_tags. 
###### REQUIREMENTS
- we created our own implementation of google_tag_manager so you could remove aldryn_google_tag_manager in the divio control panel.
