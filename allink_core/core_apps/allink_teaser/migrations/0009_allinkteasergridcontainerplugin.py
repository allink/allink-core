# Generated by Django 2.2.19 on 2021-03-19 17:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('columns', models.CharField(choices=[('1-of-1', 'One Column'), ('1-of-2', 'Two Columns'), ('1-of-3', 'Three Columns'), ('1-of-4', 'Four Columns')], default=('1-of-1', 'One Column'), help_text='Choose columns.', max_length=50, verbose_name='Columns')),
                ('column_order', models.CharField(choices=[('default', 'Default'), ('inverted', 'Inverted'), ('alternating', 'Alternating')], default=('default', 'Default'), help_text='Choose a column order.', max_length=50, verbose_name='Column Order')),
