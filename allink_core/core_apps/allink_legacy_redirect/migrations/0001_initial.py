    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_test_result', models.BooleanField(default=None, help_text='Was the last automatic test successfull? (True = Yes, False = No, None = Not yet tested)', null=True, verbose_name='Result of last test')),
                ...
                ('language', models.CharField(max_length=200, null=True, verbose_name='Language')),
