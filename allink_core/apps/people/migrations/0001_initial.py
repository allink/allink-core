# -*- coding: utf-8 -*-
# Generated by Django 1.9.13 on 2017-06-28 15:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auto_generated_category', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='auto_generated_from_people', to='allink_categories.AllinkCategory')),
                ...
                ('preview_image', filer.fields.image.FilerImageField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='people_people_preview_image', to='filer.Image', verbose_name='Preview Image')),
            ],
            options={
                'ordering': ('sort_order',),
                'verbose_name': 'Person',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manual_entries', aldryn_common.admin_fields.sortedm2m.SortedM2MModelField(blank=True, help_text='Select and arrange specific entries, or, leave blank to select all. (If manual entries are selected the category filtering will be ignored.)', to='people.People')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_function', models.CharField(default='', max_length=255, verbose_name='Function')),
