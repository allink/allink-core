    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auto_generated_category', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='auto_generated_from_events', to='allink_categories.AllinkCategory')),
                ('categories', models.ManyToManyField(blank=True, to='allink_categories.AllinkCategory')),
                ('content_additional_placeholder', cms.models.fields.PlaceholderField(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='events_events_content_additional_placeholder', slotname='events_content_additional', to='cms.Placeholder')),
                ...
                ('location', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='events', to='locations.Locations')),
                ...
                ('preview_image', filer.fields.image.FilerImageField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='events_events_preview_image', to='filer.Image', verbose_name='Preview Image')),
            ],
            options={
                'verbose_name': 'Event',
