# Generated by Django 2.2.17 on 2021-01-07 10:34
...
def forwards_func(apps, schema_editor):
    ...
    for object in BaseLocations.objects.all():
        ...
        if object_translation is not None:
            object_translation.country_translatable = object.country
...
def backwards_func(apps, schema_editor):
    ...
    for object in BaseLocations.objects.all():
        ...
        object.country = translation.country_translatable
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('locations', '0011_locationstranslation_country_translatable'),
    ]
