...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.CharField(default='Contact request', max_length=255, verbose_name='Contact verbose name'),
        ),
        migrations.AlterField(
            model_name='allinkconfig',
            name='contact_verbose_plural',
            field=models.CharField(default='Contact requests', max_length=255, verbose_name='Contact verbose name plural'),
        ),
        migrations.AlterField(
            model_name='allinkconfig',
