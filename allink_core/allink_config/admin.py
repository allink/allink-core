    ...
    def get_fieldsets(self, request, obj=None):
        ...
        fieldsets += (_('App Names and Toolbar'), {
            ...
            'fields': (
                ...
                ('blog_toolbar_enabled',),
                ('news_verbose', 'news_verbose_plural',),
                ('news_toolbar_enabled',),
                ('events_verbose', 'events_verbose_plural',),
                ('events_toolbar_enabled',),
                ('locations_verbose', 'locations_verbose_plural',),
                ('locations_toolbar_enabled',),
                ('people_verbose', 'people_verbose_plural',),
                ('people_toolbar_enabled',),
                ('testimonial_verbose', 'testimonial_verbose_plural',),
                ('testimonial_toolbar_enabled',),
                ('work_verbose', 'work_verbose_plural',),
                ('work_toolbar_enabled',),
                ('members_verbose', 'members_verbose_plural',),
                ('members_toolbar_enabled',),
                ('contact_verbose', 'contact_verbose_plural',),
                ('contact_toolbar_enabled',),
                ('events_registration_verbose', 'events_registration_verbose_plural',),
                ('events_registration_toolbar_enabled',),
            )
        }),
