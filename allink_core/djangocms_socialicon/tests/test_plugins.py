...
import allink_core.djangocms_socialicon as app
from allink_core.djangocms_socialicon.cms_plugins import CMSAllinkSocialIconContainerPlugin, CMSAllinkSocialIconPlugin
