    ...
    def handle(self, *args, **options):
        ...
        msg = (
            """
                ...
                3. add ('{model_name}Apphook', {{'detail': ('apps.{app_label}.models.{model_name}', ['slug'])}}),
                 to PROJECT_LINK_APPHOOKS \n
                4. create a new tuple {model_name_upper}_PLUGIN_TEMPLATES and add all templates from templates/ dir \n
                5. (optional): add ('{model_name_lower}', '{model_name}'), to PROJECT_APP_MODEL_WITH_CATEGORY_CHOICES
                 if the app should have categories\n
