...
from allink_core.core.customisation.new_app import new_app


class Command(BaseCommand):
    help = ("Create a new app with all the basic functionality a allink app has.")
    ...
    def handle(self, *args, **options):
        ...
        try:
            new_app(app_label, folder_path, logger)
