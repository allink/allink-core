...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('djangocms_content', '0012_auto_20161128_0712'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            name='AllinkContent',
            fields=[
                ('cmsplugin_ptr', models.OneToOneField(parent_link=True, related_name='djangocms_content_allinkcontent', auto_created=True, primary_key=True, serialize=False, to='cms.CMSPlugin')),
                ...
                ('bg_color_enabled', models.BooleanField(default=False, verbose_name='Set a predefined background color')),
                ...
                ('css_classes', models.CharField(help_text='Comma separated class names. Only letters, numbers, hyphen and underscores are allowed in class names.', max_length=255, null=True, verbose_name='CSS Classes', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('cmsplugin_ptr', models.OneToOneField(parent_link=True, related_name='djangocms_content_allinkcontentcolumn', auto_created=True, primary_key=True, serialize=False, to='cms.CMSPlugin')),
